...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO client_job (client_id,category_id, country_id, job_title, budget, deadline_date, description) 
            VALUES ('$id','$categoryId', '$countryId', '$jobTitle', '$budget', '$deadlineDate', '$description')";
