...
$_SESSION['client_name'] = $login_session_username; // Replace with the actual variable containing the user's email
    ...
    <div class="main-wrapper">
      ...
      <nav class="sidebar">
        <div class="sidebar-header">
          <a href="#" class="sidebar-brand"> Ifanni<span>.sa</span>
         </a>
        ...
        <div class="sidebar-body">
          <ul class="nav">
              <li class="nav-item">
                  <h5 class="link-title">Client Panel</h5>
              </li>
            ...
            <li class="nav-item">
              <a href="view-invoice.php" class="nav-link">
                <i class="link-icon" data-feather="box"></i>
                <span class="link-title">View Invoice</span>
              </a>
            </li>
            <li class="nav-item">
              ...
              <li class="nav-item dropdown">
                ...
                >
                  ...
                  >
                    ...
                    <p class="tx-16 fw-bolder">Welcome, <?php echo $_SESSION['client_name']; ?></p>
                     <p class="tx-12 text-muted"><?php echo $_SESSION['client_email']; ?></p>
                    </div>
                  </div>
                  <ul class="list-unstyled p-1">
                    ...
                    <li class="dropdown-item py-2">
                      <a href="edit-profile.php" class="text-body ms-0">
