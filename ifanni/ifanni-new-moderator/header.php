...
include('session.php');
// Get the moderator's email from the session
$moderatorEmail = $_SESSION['moderator_email'];

// Extract the name before the "@" symbol
$emailParts = explode('@', $moderatorEmail);
    ...
    <div class="main-wrapper">
      ...
      <nav class="sidebar">
        ...
        <ul class="nav">
            ...
            <!--<li class="nav-item mb-3">
              <a href="all-services.php" class="nav-link">
                <i class="link-icon" data-feather="users"></i>
                <span class="link-title">Services</span>
              </a>
            </li>
            <li class="nav-item mb-3">
              <a href="all-equipment.php" class="nav-link">
                <i class="link-icon" data-feather="users"></i>
            ...
            <li class="nav-item mb-3">
              <a href="all-company.php" class="nav-link">
            ...
            <li class="nav-item mb-3">
              <a href="all-service-city.php" class="nav-link">
            ...
            <li class="nav-item mb-3">
              <a href="invoices.php" class="nav-link">
                ...
                <span class="link-title">Issue Invoice</span>
              </a>
            </li>
<!--            <li class="nav-item mb-3">-->
...
<!--            </li>-->
      ...
      <div class="page-wrapper">
              ...
              <li class="nav-item dropdown">
                ...
                >
                  ...
                  >
                    ...
                    <p class="tx-16 fw-bolder"><?php echo $nameBeforeAt; ?></p>
                      <p class="tx-12 text-muted"><?php echo $_SESSION['moderator_email']; ?></p>
                    </div>
                  </div>
        ...
        <?php
$newJobCount = $count1; // Replace this with the actual count
$newCount2  = $count2;
?>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (newJobCountElement2) {
            newJobCountElement2.textContent = "<?php echo $newCount2; ?>";
        }
