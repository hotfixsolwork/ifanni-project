...
$_SESSION['service_provider_name'] = $login_session_username; // Replace with the actual variable containing the user's email
?>
<!DOCTYPE html>
<html lang="en">
<head>
              ...
              <li class="nav-item dropdown">
                ...
                >
                  ...
                  >
                    ...
                    <p class="tx-16 fw-bolder">Welcome, <?php echo $_SESSION['service_provider_name']; ?></p>
                     <p class="tx-12 text-muted"><?php echo $_SESSION['service_provider_email']; ?></p>
                    </div>
                  </div>
