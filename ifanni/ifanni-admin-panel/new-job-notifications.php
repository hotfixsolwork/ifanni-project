                ...
                <div class="card-body">
                  ...
                  <table id="dataTableExample" class="table table-bordered">
                      ...
                      <tbody id="countryTableBody">
                              ...
                              $sql = " SELECT j.id, j.job_title, j.budget, c.client_name AS client_name, c.client_email AS client_email, c.client_phone AS client_phone, c.client_adress AS client_adress
                                    FROM client_job j
