                ...
                <div class="card-body">
                  ...
                  <table id="dataTableExample" class="table table-bordered">
                      <thead>
                          ...
                          <th class="text-center">Serivce Provider Name</th>
                          <th class="text-center">Serivce Provider Email</th>
                          <th class="text-center">Serivce Provider Contact</th>
                          <!-- <th class="text-center">Serivce Provider Address</th> -->
