...
?>
    ...
    <div class="row">
        ...
        <!--<div class="col-sm-12">
            <div class="mb-3">
                ...
                >
                    <?php
                    // Fetch the list of countries from your database and store them in an array
                    $countries = array();
                    ...
                    if ($result_countries->num_rows > 0) {
                        while ($row_country = $result_countries->fetch_assoc()) {
                            $countries[$row_country['id']] = $row_country['name'];
                        }
                    }

                    // Now, populate the select options and set the selected option based on the current country ID
                    foreach ($countries as $country_id => $country_name) {
                        $selected = ($country_name == $countryName) ? 'selected' : '';
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-4 justify-content-center">
            <button type="submit" class="btn btn-primary submit">Update City</button>
        </div>
    </div>
</form>
