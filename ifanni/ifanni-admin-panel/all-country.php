...
?>
        ...
        <div class="page-content">
          <h4 class="mt-3 mb-3 mx-3">All Country</h4>
                              ...
                              $sql = "SELECT * FROM countries";
                                ...
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        <a href='edit-country.php?id=".$row["id"]."' class='btn btn-primary me-3 mb-2'><i data-feather='edit'></i></a>
                                                <button class='btn btn-danger me-2'><i data-feather='trash'></i></button>
                                            </td>";
                                        echo "</tr>";
                                    }
                                } else {
                                    echo "<tr><td colspan='5' class='text-center'>No  Country  found.</td></tr>";
                                }
